        ...
        if show:
            with imgui_utils.grayed_out(self.disabled_time != 0):
                ...
                if imgui_utils.button(
                    "Add point", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.mode = "point"
                ...
                reset = False
                if imgui_utils.button(
                    "Reset point", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.reset_point()
                    reset = True
                ...
                imgui.same_line(viz.label_w)
                if imgui_utils.button(
                    "Start", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.is_drag = True
                ...
                imgui.same_line()
                if imgui_utils.button(
                    "Stop", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.stop_drag()
                ...
                imgui.same_line(viz.label_w)
                if imgui_utils.button(
                    "Flexible area", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.mode = "flexible"
                    self.show_mask = True
                ...
                imgui.same_line()
                if imgui_utils.button(
                    "Fixed area", width=viz.button_w, enabled="image" in viz.result
                ):
                    self.mode = "fixed"
                    self.show_mask = True
                ...
                imgui.same_line(viz.label_w)
                if imgui_utils.button(
                    "Reset mask", width=viz.button_w, enabled="image" in viz.result
                ):
